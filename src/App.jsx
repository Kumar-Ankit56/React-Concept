...
class App extends Component {
  ...
  render() {
    return (<>
      ...
      <p className="ml-12 text-blue-500">Hello {this.state.name}</p>
      <button className="ml-6 w-40 h-10 rounded bg-blue-300 text-white" onClick={()=>{this.setState({name:"Shivam"})}}>Click Me</button>
    </>
    )
  }
}
